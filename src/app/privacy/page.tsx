    ...
    <div style={{ padding: "20px", fontFamily: "Arial, sans-serif" }}>
      ...
      <main>
        <section>
          ...
          <ul>
            ...
            <li>
              ...
              system, IP address, and cookies/usage data for analytics.
            </li>
            <li>
              <strong>Service-Related Information:</strong> Details about your
              move, such as inventory, pickup and delivery addresses, and
        ...
        <section>
          ...
          <ul>
            <li>To provide and manage moving services.</li>
            <li>To communicate regarding quotes, bookings, and updates.</li>
        ...
        <section>
          ...
          <ul>
            <li>
              <strong>Service providers:</strong> For payment processing or
            ...
            <li>
              <strong>Third-party tools:</strong> For analytics and marketing
        ...
        <section>
          ...
          <p>
            We use cookies to analyze traffic, personalize your experience, and
            manage advertisements. You can disable cookies in your browser
        ...
        <section>
          ...
          <p>
            ...
            information from unauthorized access or loss. However, no method of
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              <strong>Phone:</strong> 206-665-6711
            </li>
            <li>
